...
Click **+ Add task** or run `Slate: Add task` from the command palette.
...
You can also type `#label` or `//project` directly in the title field. Slate parses these tokens and applies them automatically when you save.
